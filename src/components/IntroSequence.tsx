        ...
        <AnimatePresence mode="wait">
          ...
          {scene === 3 && (
            ...
            >
              ...
              <div className="absolute top-8 right-8 font-pixel text-[10px] text-cyan-500/40">frame 03</div>
              <div className="absolute bottom-8 right-8 font-pixel text-[10px] text-cyan-500/40">frame 01</div>
              ...
              >
                <h1 className="text-5xl md:text-8xl font-black italic uppercase text-white font-pixel text-center text-glow-cyan mb-4">
                  NULLIFIERVERSE
                </h1>
                <div className="relative">
                  <h2 className="text-4xl md:text-7xl font-black italic uppercase font-pixel text-center bg-gradient-to-r from-fuchsia-500 to-cyan-500 bg-clip-text text-transparent text-glow-magenta">
                    RHYTHM
                  </h2>
                  {/* Circuit lines effect could be added here as SVG */}
                </div>
              </motion.div>
